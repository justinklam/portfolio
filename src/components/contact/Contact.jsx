    ...
    <div className="c">
      ...
      <div className="c-wrapper">
        <div className="c-left">
          ...
          <div className="c-info">
            <div className="c-info-item">
              ...
              >
                <img src={GitHubImg} alt="" className="c-icon" />
                My GitHub
              </a>
            </div>
            <div className="c-info-item">
              <a
                href="https://www.linkedin.com/in/justinkhlam/"
                style={{ color: darkMode && "white" }}
              >
                <img src={LinkedInImg} alt="" className="c-icon" />
                My LinkedIn Profile
              </a>
            </div>
            <div className="c-info-item">
        ...
        <div className="c-right">
          <p className="c-desc">{/* <b>Reach out to me here!</b> */}</p>
